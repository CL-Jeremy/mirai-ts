 ...
 */
export declare type SingleMessage = Source | Quote | At | AtAll | Face | Plain | Image | FlashImage | Voice | Xml | Json | App | Poke | File;
 ...
 * 消息链
 */
export declare type MessageChain = Array<SingleMessage>;
 ...
 */
export declare type ChatMessage = GroupMessage | TempMessage | FriendMessage;
/**
 * 聊天消息类型
 */
export declare type ChatMessageType = ChatMessage["type"];
