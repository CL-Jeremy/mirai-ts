...
import { BotInvitedJoinGroupRequestOperationType, MemberJoinRequestOperationType, NewFriendRequestOperationType } from "../../mirai-api-http/resp";
...
export declare type MessageFromId = BaseResponse;
...
export declare type FriendList = Friend[];
export declare type GroupList = Group[];
export declare type MemberList = Member[];
